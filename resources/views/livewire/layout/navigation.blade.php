                ...
                <div class="hidden space-x-8 sm:-my-px sm:ms-10 sm:flex">
                    ...
                    @auth
                        ...
                        @if(auth()->user()->id_role == 1)
                            <x-nav-link :href="route('tambah-artikel')" :active="request()->routeIs('tambah-artikel')" wire:navigate>
                                {{ __('Tambah Artikel') }}
                            </x-nav-link>
                        @endif
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            ...
            @auth
                ...
                @if(auth()->user()->id_role == 1)
                    <x-responsive-nav-link :href="route('tambah-artikel')" :active="request()->routeIs('tambah-artikel')" wire:navigate>
                        {{ __('Tambah Artikel') }}
                    </x-responsive-nav-link>
                @endif
                @if(auth()->user()->id_role == 3)
