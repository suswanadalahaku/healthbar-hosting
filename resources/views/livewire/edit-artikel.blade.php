<div class="min-h-screen bg-gray-100 flex" wire:poll>
    <div class="bg-white shadow-lg rounded-lg p-6 w-full space-y-6">
        ...
        <!-- Form -->
        <form wire:submit.prevent="updateContent" class="space-y-6">
            <!-- Title -->
            <input 
                type="text" 
                wire:model="title" 
            ...
            <div class="w-fit h-fit border-2 border-dashed border-gray-300 rounded-lg flex justify-center items-center relative bg-gray-50">
                ...
                @if ($hasImage && $image)
                    ...
                    <img src="{{ $image->temporaryUrl() }}" alt="Uploaded Image" class="w-full h-full object-cover rounded-lg">
                @elseif ($existingImage)
                    <!-- Pratinjau Gambar Lama -->
                    <img src="{{ Storage::url($existingImage) }}" alt="Existing Image" class="w-full h-full object-cover rounded-lg">
                @else
                    <!-- Area Unggah Gambar -->
